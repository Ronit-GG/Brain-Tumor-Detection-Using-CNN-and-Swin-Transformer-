...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{Figure_02_sample_mri_per_class.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{Figure_06_preprocessing_effect.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{Figure_07_augmentation_examples.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{Figure_28_gradcam_correct.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{Figure_29_gradcam_misclassified.png}
